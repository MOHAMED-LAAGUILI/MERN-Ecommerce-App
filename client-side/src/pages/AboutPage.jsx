...
export default function AboutPage() {
  return (
    <Layout title={"About"} >
      <div className="bg-gray-100 dark:bg-gray-800 transition-colors duration-500 py-16 px-4 overflow-hidden sm:px-6 lg:px-8" style={{ minHeight: "79.5vh" }} >
        <div className="relative max-w-7xl mx-auto">
          <main className="mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8">
            <div className="sm:text-center lg:text-left">
              ...
              <p className="dark:text-white mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
