  ...
  return (
    <Layout title={'Privacy Policy'} >
      <div className="bg-white  overflow-hidden sm:px-6 ">
        <div className="dark:bg-gray-800 relative pt-20 transition-colors duration-500" style={{ minHeight: "79.5vh" }}>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4 mb-6 ">
                  <button 
                    ...
                    className={`py-2 px-4 font-semibold rounded-lg ${activeTab === "return" ? "bg-indigo-600 text-white" : "bg-indigo-200 text-gray-700"} hover:bg-indigo-500`}
                    onClick={() => setActiveTab("return")}
                  >
                    Return Policy
                  </button>
                  <button
                    className={`py-2 px-4 font-semibold rounded-lg ${activeTab === "shipping" ? "bg-indigo-600 text-white" : "bg-indigo-200 text-gray-700"} hover:bg-indigo-500`}
                    onClick={() => setActiveTab("shipping")}
                  >
                    Shipping Policy
                  </button>
                  <button
                    className={`py-2 px-4 font-semibold rounded-lg ${activeTab === "payment" ? "bg-indigo-600 text-white" : "bg-indigo-200 text-gray-700"} hover:bg-indigo-500`}
                    onClick={() => setActiveTab("payment")}
                  >
                    Payment Policy
                  </button>
                  <button
                    className={`py-2 px-4 font-semibold rounded-lg ${activeTab === "privacy" ? "bg-indigo-600 text-white" : "bg-indigo-200 text-white-700"} hover:bg-indigo-500`}
                ...
                <div className="pt-6 ">
                  {activeTab === "return" && (
                    <>
                      <h2 className="dark:text-white text-lg leading-6 font-medium text-gray-900">Return Policy</h2>
                  ...
                  {activeTab === "shipping" && (
                    <>
                      <h2 className="dark:text-white text-lg leading-6 font-medium text-gray-900">Shipping Policy</h2>
                      <p className="mt-2 text-base text-gray-500">
                  ...
                  {activeTab === "payment" && (
                    <>
                      <h2 className="dark:text-white text-lg leading-6 font-medium text-gray-900">Payment Policy</h2>
                      <p className="mt-2 text-base text-gray-500">
                  ...
                  {activeTab === "privacy" && (
                    <>
                      <h2 className="dark:text-white text-lg leading-6 font-medium text-gray-900">Privacy Policy</h2>
                      <p className="mt-2 text-base text-gray-500">
