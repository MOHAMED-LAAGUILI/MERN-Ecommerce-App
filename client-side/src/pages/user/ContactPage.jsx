...
export default function ContactPage() {
  return (
    <Layout title={"Contact Us"}>
      <div
        className="mx-auto p-4 pt-6 md:p-6 lg:p-12 xl:p-24 bg-white  dark:bg-gray-800 dark:text-white transition-colors duration-500"
      ...
      >
        ...
        <p className="text-lg mb-6 text-gray-700 text-center dark:text-white">
          ...
          comment, or just want to say hello, please dont hesitate to reach out.
        </p>
        ...
        <div className="mt-8 ">
          ...
          <ul className="text-gray-700 dark:text-white">
            <li>
              Phone: <span className="font-medium">555-555-5555</span>
            </li>
            <li>
              Email:{" "}
