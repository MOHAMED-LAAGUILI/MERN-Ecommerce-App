            ...
            {auth.token ? (
              ...
              <div className="bg-gray-100 p-4 rounded-md shadow-sm">
                ...
                <div className="flex flex-wrap justify-center mb-4 p-5">
                  <button className=" me-5  bg-orange-500 text-white px-6 py-3 rounded-lg shadow-md hover:bg-orange-700 transition duration-200 mr-4">
                    <FaCreditCard className="inline-block mr-1" /> Credit
                    /Debit Card
                  </button>
                  <button className="bg-blue-500 text-white px-6 py-3 rounded-lg shadow-md hover:bg-blue-700 transition duration-200">
...
<br />
              <b>
                Your Current contact Number<br />
              </b>
                {auth.user.phone}
              <br />
              <button
            ...
            <>
              <p className="md:2/4 text-gray-600 mb-4">
                You need to be logged in to view your cart and proceed to checkout.
              </p>
              <div className="mt-4">
                      <button
